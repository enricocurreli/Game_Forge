...
const PlatformView = () => {
  ...
  if (genre == "all") {
    url = `https://api.rawg.io/api/games?key=${API_KEY}&platforms=${id}&page_size=15&page=${page}`;
  } else {
    url = `https://api.rawg.io/api/games?key=${API_KEY}&platforms=${id}&page_size=15&page=${page}&genres=${genre}`;
  }
