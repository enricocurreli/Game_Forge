...
const SearchView = () => {
    ...
    return (
        ...
        <Section classes={"my-10 px-16"}>
          ...
          <Article classes={"my-16 lg:px-10 grid lg:grid-cols-3 lg:gap-8"}>
            

          {
          loading ? <div className="h-screen w-[100%] flex justify-center absolute  left-0 top-0 loaderCstm"><div className="loading loading-bars  bg-orange-600 lg:w-24 w-14"></div></div>
